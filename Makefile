...
OFILES = main.o ship.o enemy_ship1.o enemy_ship2.o enemy_ship3.o welcome_screen.o end_screen.o mylib.o text.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = ship.h enemy_ship1.h enemy_ship2.h enemy_ship3.h welcome_screen.h end_screen.h mylib.h text.h
